...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
     ...
     if (isset($_POST['modifier'])){
        ...
        UpdateForUser($nom,$prenom,$email,$mot_de_passe,$id);
  ...
  <h1>Modifier Mes Infos</h1>
        ...
        <div class="container">
           ...
           <div class="mb-3">
                    ...
                    <input type="text" name="nom"  class="form-control" value="<?php echo $User['nom'] ?>"  placeholder="nom">
            </div>
            <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Prenom</label>
                    <input type="text"  name="prenom" class="form-control" value="<?php echo $User['prenom'] ?>"  placeholder="prenom">
            </div>
            
           <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Email address</label>
                    <input type="email" name="email" class="form-control" value="<?php echo $User['email'] ?>"  placeholder="nom@exemple.com">
            </div>
