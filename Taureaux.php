...
<header>
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="Taureaux.php">Taureaux</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="Génisses.php">Génisses</a>
          </li>
          </li>
        ...
        <div class="card" style="width: 18rem;">
              ...
              <a href=<?php echo "Taureaux.php?id=".$taureau['id'];?>>
                  ...
                  <div class="card-body">
                   ...
                   <a href="./VuePanier.php?id=<?php echo$taureau['id'] ;?>" class="btn btn-warning"name="btnAchat" type="submit">Acheter</a> 
